          ...
          children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text.rich(
                        TextSpan(
                          children: [
                            TextSpan(text: 'Experience ', style: TextStyle(color: Colors.grey)),
                            TextSpan(
                              text: '15 years   ',
                              style: TextStyle(fontWeight: FontWeight.bold),
                            ),
                            TextSpan(text: 'Consultation ', style: TextStyle(color: Colors.grey)),
                            TextSpan(
                              text: '1000/-',
                              style: TextStyle(fontWeight: FontWeight.bold),
                            ),
            ...
            const Row(
              children: [
                ...
                SizedBox(width: 10),
                Text("Time Slot", style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold)),
              ],
            ),
            ...
            Wrap(
              ...
              children: List.generate(
                6,
                  ...
                  onTap: () {
                    // Handle tap - maybe use GetX to set selected index
