...
class AppRoutes {
  static openRoutes() => [
    ...
    GetPage(name: RoutesName.doctorAppointment, page: () => DoctorAppointmentScreen()),
    GetPage(name: RoutesName.doctorProfileCards, page: () => DoctorsAppointmentPage()),
    ...
    GetPage(name: RoutesName.confirmationAppointment, page: () => AppointmentConfirmedScreen()),
    GetPage(name: RoutesName.ambulanceServices, page: () => AmbulanceServiceScreen()),
    GetPage(name: RoutesName.emergencyContacts, page: () => EmergencyContactsScreen()),
    GetPage(name: RoutesName.bedAvailability, page: () => BedAvailabilityScreen()),
    GetPage(name: RoutesName.pharmacy, page: () => PharmacyScreen()),
    GetPage(name: RoutesName.hospitalNearMe, page: () => HospitalListScreen()),
    GetPage(name: RoutesName.hospitalDetailPage, page: () => HospitalDetailsScreen()),
